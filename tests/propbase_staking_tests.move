...
module propbase::propbase_staking_tests {
    ...
    #[test(resource = @propbase, admin = @source_addr, address_1 = @0xA, address_2 = @0xB, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0x50023, location = propbase_staking )]
    fun test_failure_add_stake_pool_min_stake_not_set(
        resource: &signer,
        admin: &signer,
        address_1: &signer,
        address_2: &signer,
    ...
    #[test(resource = @propbase, admin = @source_addr, address_1 = @0xA, address_2 = @0xB, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0x50023, location = propbase_staking )]
    fun test_failure_add_stake_pool_max_stake_not_set(
        resource: &signer,
        admin: &signer,
        address_1: &signer,
        address_2: &signer,
    ...
    #[test(resource = @propbase, admin = @source_addr, address_1 = @0xA, address_2 = @0xB, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0x50023, location = propbase_staking )]
    fun test_failure_add_stake_pool_interest_rate_not_set(
        resource: &signer,
        admin: &signer,
        address_1: &signer,
        address_2: &signer,
    ...
    #[test(resource = @propbase, admin = @source_addr, address_1 = @0xA, address_2 = @0xB, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0x50023, location = propbase_staking )]
    fun test_failure_add_stake_pool_start_time_not_set(
        resource: &signer,
        admin: &signer,
        address_1: &signer,
        address_2: &signer,
    ...
    #[test(resource = @propbase, admin = @source_addr, address_1 = @0xA, address_2 = @0xB, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 65565, location = propbase_staking )]
    fun test_failure_add_stake_pool_cap_not_set(
        resource: &signer,
        admin: &signer,
        address_1: &signer,
        address_2: &signer,
        ...
        propbase_staking::create_or_update_stake_pool(admin,string::utf8(b"Hello"), 0, 80000, 250000, 15, 50, 1000000000, 10000000000, 31622400, update_config);
        fast_forward_secs(10000);
    ...
    #[test(resource = @propbase, admin = @source_addr, address_1 = @0xA, address_2 = @0xB, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 327715, location = propbase_staking )]
    fun test_failure_add_stake_pool_cap_and_max_amount_not_set(
        resource: &signer,
        admin: &signer,
        address_1: &signer,
        address_2: &signer,
        ...
        propbase_staking::create_or_update_stake_pool(admin,string::utf8(b"Hello"), 0, 80000, 250000, 15, 50, 1000000000, 0, 31622400, update_config);
        fast_forward_secs(10000);
    ...
    #[test(resource = @propbase, admin = @source_addr, address_1 = @0xA, address_2 = @0xB, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0x50023, location = propbase_staking )]
    fun test_failure_add_stake_pool_penalty_rate_not_set(
        resource: &signer,
        admin: &signer,
        address_1: &signer,
        address_2: &signer,
    ...
    #[test(resource = @propbase, admin = @source_addr, address_1 = @0xA, address_2 = @0xB, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0x50023, location = propbase_staking )]
    fun test_failure_withdraw_excess_rewards_penalty_rate_not_set(
        resource: &signer,
        admin: &signer,
        address_1: &signer,
        address_2: &signer,
    ...
    #[test(resource = @propbase, admin = @source_addr, address_1 = @0xA, address_2 = @0xB, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0x50023, location = propbase_staking )]
    fun test_failure_withdraw_excess_rewards_min_stake_amount_not_set(
        resource: &signer,
        admin: &signer,
        address_1: &signer,
        address_2: &signer,
    ...
    #[test(resource = @propbase, admin = @source_addr, address_1 = @0xA, address_2 = @0xB, aptos_framework = @0x1)]
    #[expected_failure(abort_code = 0x50023, location = propbase_staking )]
    fun test_failure_withdraw_excess_rewards_max_stake_amount_not_set(
        resource: &signer,
        admin: &signer,
        address_1: &signer,
        address_2: &signer,
